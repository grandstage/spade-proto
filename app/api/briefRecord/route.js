...
export async function GET(req) {
  ...
  try {
    ...
    const fields = {
        BriefName: record.fields['Brief Name'],
        CustomerProduct: record.fields['Customer Product'],           
        CompetitorProduct: record.fields['Competitor Product'],         
        BriefBody: record.fields['Brief Body'],
        ValueProposition: record.fields['Value Proposition'],
        FeatureComparison: record.fields['Feature Comparison'],
        Strengths: record.fields['Strengths'],
        Weaknesses: record.fields['Weaknesses'],
